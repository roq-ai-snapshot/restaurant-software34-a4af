      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        {isLoading || (!formik.values && !error) ? (
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <FormControl id="customization" mb="4" isInvalid={!!formik.errors.customization}>
              ...
              />
              {formik.errors.customization && <FormErrorMessage>{formik.errors.customization}</FormErrorMessage>}
            </FormControl>
